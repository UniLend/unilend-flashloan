...
export const connectWalletAction = (wallet?: Wallet) => {
  return async (dispatch: Dispatch<Action>) => {
    ...
    try {
      ...
      let accounts: any;
      if (wallet && wallet.name === "metamask") {
      ...
      } else if (wallet && wallet.name === "walletConnect") {
      ...
      } else if (wallet && wallet.name === "CoinbaseWallet") {
      ...
      } else if (wallet && wallet.name === "Formatic") {
        try {
      ...
      } else if (wallet && wallet.name === "Portis") {
